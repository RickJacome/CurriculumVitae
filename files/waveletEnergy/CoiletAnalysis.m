...
%Wavelet Decomposition 
 ...
 % L = # of Coefficients per level detail (level resolution), 
 % number of C_j
 % C = "Wavelet Decomp. Vector" 
 % This vector has all the coefficients stuck together.
 % L, helps to classify them. 
 % First Level of Decomp Always has the greatest number
 % of Coefficients. It goes in descending order afterwards.
