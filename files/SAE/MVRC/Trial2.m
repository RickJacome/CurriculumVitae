clear; close all; clc
%Google Earth Data
load('RoadTrial2.mat'); %GPS Data
Long = RoadTrial2S1.Long;
Lat = RoadTrial2S1.Lat;
Long = Long(1:20:end);
Lat = Lat(1:20:end);
load('RoadTrial2Transformed.mat'); %Data in Feet
x2 = GPScoordtrans.XRoad; y2 = GPScoordtrans.YRoad;
