...
steps = 500;   %Amount of steps to simulate
...
plot(x_(1,:),'-k','linewidth',1.5);                 %plot the Kalman filter prediction over the plant
...
grid on;
legend('Real Plant','Observations','Kalman Filter Prediction','Original Thought','Upper Threshold','Lower Threshold')
