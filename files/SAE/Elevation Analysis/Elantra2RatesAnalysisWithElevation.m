%Rates Analysis With Elevation for Elantra Trial 2
clc; clear all; close all
load('ElantraTrial2.mat')
v = ElantraTrial2.Speedms;
tm = ElantraTrial2.time;
xr = ElantraTrial2.wx; yr = ElantraTrial2.wy; zr = ElantraTrial2.wz;
Lat = ElantraTrial2.Latitude; Long = ElantraTrial2.Longitude;
...
title ('Elantra-2 Results'); xlim([0.4 1])
xlabel('Distance (km)');ylabel('Pitch Angle (deg)');
