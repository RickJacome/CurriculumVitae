%Rates Analysis With Elevation for Altima Trial 2
clc; clear all; close all
load('AltimaTrial2.mat')
v = AltimaTrial2.Speedms;
tm = AltimaTrial2.time;
xr = AltimaTrial2.wx; yr = AltimaTrial2.wy; zr = AltimaTrial2.wz;
Lat = AltimaTrial2.Latitude; Long = AltimaTrial2.Longitude;
...
title ('Altima-2 Results'); xlim([0.4 1])
xlabel('Distance (km)');ylabel('Pitch Angle (deg)');
