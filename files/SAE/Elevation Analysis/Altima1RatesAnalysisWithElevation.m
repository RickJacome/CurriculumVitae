%Rates Analysis With Elevation for Altima Trial 1
clc; clear all; close all
load('AltimaTrial1.mat')
v = AltimaTrial1.Speedms;
tm = AltimaTrial1.time;
xr = AltimaTrial1.wx; yr = AltimaTrial1.wy; zr = AltimaTrial1.wz;
Lat = AltimaTrial1.Latitude; Long = AltimaTrial1.Longitude;
