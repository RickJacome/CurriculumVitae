...
%The equation we wish to solve is f''' + (1/2)*f*f'' with 
%BC   f(0) = 0, f'(0) = 0,f'(inf) = 1.
%We recast this problem as a system of first-order ODEs: y =
%[f; f'; f''] = [y(1); y(2); y(3)]
%so that dy/dEta = y' = [f'; f''; f'''] = [y(2); y(3); -(1/2)*y(1)*y(3)] 
%with y(1)(0) = 0, y(2)(0) = 0, y(2)(inf) = 1.
